...
struct Detail : View{
    ...
    var body: some View{
        ...
        .background(LinearGradient(gradient: .init(colors: [Color("Color2"), Color("Color3")]), startPoint: .top, endPoint: .bottom))
        .edgesIgnoringSafeArea(.all)
        .navigationBarTitle("",displayMode: .inline)
    .navigationBarBackButtonHidden(true)
    .navigationBarHidden(true)
...
var data = [
    ...
    Player(id: 2, powers: [0.2,0.5,0.9], image: "Player3", name: "Whore", color: Color("Color2"))
]
